...
class CollecteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'consentement' => 'required', // On accepte tout type, on convertit après
        ]);
        ...
        try {
            // 2. Trouver l'utilisateur par son agent_id
            $user = \App\Models\User::where('agent_id', $request->agent_id)->first();

            // 3. Création de la collecte
            // NOTE : On retire 'synchro' car la colonne n'existe pas dans la table PostgreSQL
            $collecte = Collecte::create([
                ...
                'consentement' => $request->consentement ? 1 : 0, // Conversion propre pour INTEGER
            ]);
            ...
            // En cas d'erreur, on renvoie le message précis pour débugger
            return response()->json([
