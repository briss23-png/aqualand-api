...
// Route pour recréer la table collectes (user_id nullable)
Route::get('/fix', function () {
    \DB::statement('PRAGMA foreign_keys=off;');
    \DB::statement('ALTER TABLE collectes RENAME TO collectes_old;');
    \DB::statement('
    ...
    return 'Table collectes recréée avec user_id nullable';
});
